...
<head>
  <meta charset="UTF-8">
  <title>iLib Documentation</title>
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,700|Source+Code+Pro:300,600|Titillium+Web:400,600,700" rel="stylesheet">
  <link rel="stylesheet" type="text/css" href="./swagger-ui.css" >
  <link rel="icon" type="image/png" href="./assets/img/rel-icon.png" sizes="32x32" />
  <link rel="icon" type="image/png" href="./assets/img/rel-icon.png" sizes="16x16" />
  <style>
    html
    {
